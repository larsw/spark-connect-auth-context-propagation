...
**Status:** design locked 2026-09-18. **Complete.** All milestones done, all four open risks resolved, 11/11 tests pass end to end.
...
`11 passed` in `tests/test_propagation.py`, run from the compose `client` service:
