...
**Status:** design locked 2026-09-18. **Complete.** All milestones done, all four open risks resolved. 13 end-to-end checks pass against the live stack, plus 41 unit tests (15 Java, 26 Python) that need nothing running.
