...
**Status:** complete and verified. 13 end-to-end checks against the live stack, plus 41 unit tests.
...
all. Between them: 26 unit tests, 13 end-to-end, and 15 Java tests via `make jar`.
